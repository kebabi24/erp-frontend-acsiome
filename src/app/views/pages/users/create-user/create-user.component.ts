...
export class CreateUserComponent implements OnInit {
  ...
  onChangeCode() {
    ...
    this.userService.getByOne({ usrd_code: controls.usrd_code.value }).subscribe((res: any) => {
  ...
  onChangeUser() {
    ...
    this.userService.getByOne({ usrd_user_name: controls.usrd_user_name.value }).subscribe((res: any) => {
      console.log("aa", res.data);
