...
import { UsersService, SiteService, PrintersService } from "../../../core/erp";
...
@NgModule({
  declarations: [UsersComponent, CreateUserComponent, UsersListComponent, EditUserComponent, ChangeUserComponent],
  imports: [
    CommonModule,
    HttpClientModule,
    PartialsModule,
