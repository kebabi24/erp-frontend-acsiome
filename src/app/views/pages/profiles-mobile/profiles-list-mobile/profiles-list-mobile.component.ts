...
@Component({
  ...
  templateUrl: './profiles-list-mobile.component.html',
  styleUrls: ['./profiles-list-mobile.component.scss']
})
export class ProfilesMobileListComponent implements OnInit {
