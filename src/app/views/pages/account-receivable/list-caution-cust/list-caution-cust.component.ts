...
@Component({
  selector: 'kt-list-caution-cust',
  templateUrl: './list-caution-cust.component.html',
  styleUrls: ['./list-caution-cust.component.scss']
})
export class ListCautionCustComponent implements OnInit {
...
banks: [];
  ...
  clearGroupingSelectsp() {
    ...
    printpdf() {
      ...
      doc.setFontSize(14);
      doc.text("Liste des Cautions    " , 80, 40);
      doc.setFontSize(12);
     ...
     //   console.log(mts)
      ...
      doc.line(205, 55, 205, 60);
          ...
          i = i + 5;
          total = total + Number(data[j].bkh_amt)
         }
