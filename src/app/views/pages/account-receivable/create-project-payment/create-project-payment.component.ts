...
@Component({
  selector: 'kt-create-project-payment',
  templateUrl: './create-project-payment.component.html',
  styleUrls: ['./create-project-payment.component.scss']
})
export class CreateProjectPaymentComponent implements OnInit {
      ...
      
      {
       ...
       onCellChange: (e: Event, args: OnEventArgs) => {
        ...
        this.find = false;
                  ...
                  this.accountReceivableService.getByOne({ar_nbr: args.dataContext.ard_ref, ar_type: "I", ar_open: true ,ar_po: controls.chr01.value}).subscribe((resp:any)=>{
...
this.gridService.updateItemById(args.dataContext.id,{...args.dataContext , applied: app })
  ...
  createForm() {
    ...
    //    so__chr01: [this.accountReceivable.ar__chr01],
       ...
       // ar_type:  [{value: this.accountReceivable.ar_type ,disabled: !this.isExistc }, Validators.required],
        ...
        chr01:  [{value: this.accountReceivable.chr01 ,disabled: !this.isExistc }],
  ...
  prepareAP(): any {
   ...
   _ar.chr01 = controls.chr01.value;
...
onChangeCodePM(){
  ...
  this.projectService
  .getBy({pm_code:controls.chr01.value})
  .subscribe((response: any) => {this.pmss = response.data.project
    console.log(this.pmss)
  if (this.pmss.length == 0 ) {
    alert("not exist")
  }
...
prepareGrid4() {
  ...
  // fill the dataset with your data
  this.accountReceivableService
    .getBy({ar_bill: controls.ar_bill.value, ar_type: "I", ar_open: true,ar_po:controls.chr01.value})
...
this.gridServicecf.addItem(
    ...
    //  console.log(resp.data.bank)
      ...
      //       controls.chr01.setValue(item.pm_code || "");
      //     });
      //   }
      // }
      ...
      //   // fill the dataset with your data
      //   this.projectService
      //     .getBy({pm_cust:controls.ar_bill.value})
      //     .subscribe((response: any) => {this.pmss = response.data.project
      //       console.log(this.pmss)})
      // }
      // openpm(content) {
      ...
      prepareGrid5() {
        ...
        this.projectService
          .getAll()
          .subscribe((response: any) => (this.pmss = response.data));
      }
      open5(content) {
        this.prepareGrid5();
        this.modalService.open(content, { size: "lg" });
