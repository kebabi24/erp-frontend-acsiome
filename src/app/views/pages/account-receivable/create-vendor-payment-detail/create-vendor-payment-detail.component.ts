...
@Component({
  selector: 'kt-create-vendor-payment-detail',
  templateUrl: './create-vendor-payment-detail.component.html',
  styleUrls: ['./create-vendor-payment-detail.component.scss']
})
export class CreateVendorPaymentDetailComponent implements OnInit {
  rvForm: FormGroup;
    ...
    this.bankService.addBkhPaymentDetail({
      ...
      .subscribe(
        ...
        () => {
          ...
          this.reset()
          this.router.navigateByUrl("/account-receivable/create-vendor-payment-detail");
