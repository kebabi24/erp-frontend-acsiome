...
import { VendorProposalService } from "../../../../core/erp"
...
@Component({
  selector: 'kt-vendor-proposal-list',
  templateUrl: './vendor-proposal-list.component.html',
  styleUrls: ['./vendor-proposal-list.component.scss']
})
export class VendorProposalListComponent implements OnInit {
   ...
   constructor(
       ...
       private vpService: VendorProposalService
   ) {
       this.prepareGrid()
   }
   ...
   createCode() {
       this.router.navigateByUrl("purchasing/create-vendor-proposal")
   }
   prepareGrid() {
       ...
       this.gridOptions = {
           ...
           rowDetailView: {
             ...
             viewComponent: RowDetailViewVpComponent,
