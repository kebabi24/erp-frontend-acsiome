      ...
      calculatetot(){
        const controls = this.totForm.controls 
         ...
         for (var i = 0; i < this.dataset.length; i++) {
           ...
           tht += round((this.dataset[i].vdhp_price * ((100 - this.dataset[i].vdhp_disc_pct) / 100 ) *  this.dataset[i].vdhp_inv_qty),2)
           if(controlsso.vhp_taxable.value == true) tva += round((this.dataset[i].vdhp_price * ((100 - this.dataset[i].vdhp_disc_pct) / 100 ) *  this.dataset[i].vdhp_inv_qty) * (this.dataset[i].vdhp_taxc ? this.dataset[i].vdhp_taxc / 100 : 0),2)
