...
@Component({
  selector: 'kt-edit-vendor-proposal',
  templateUrl: './edit-vendor-proposal.component.html',
  styleUrls: ['./edit-vendor-proposal.component.scss']
})
export class EditVendorProposalComponent implements OnInit {
  ...
  total:any = 0;
curr: String;
vendorProposalEdit: any
user:any
domain:any
reqdate: any;
needdate: any;
title: String = "Modifier Devis  - "
vendname: any
  constructor(
  ...
  ngOnInit(): void {
    ...
    // this.createForm()
     ...
     this.activatedRoute.params.subscribe((params) => {
       const id = params.id
       this.vendorProposalService.getOne(id).subscribe((response: any)=>{
           console.log(response.data)
         this.vendorProposalEdit = response.data.vendorProposal
         this.dataset = response.data.details
         this.reqdate = new Date(this.vendorProposalEdit.vp_date)
         this.needdate = new Date(this.vendorProposalEdit.vp_q_date)
         this.reqdate.setDate(this.reqdate.getDate() )
         this.needdate.setDate(this.needdate.getDate() )
         console.log(this.vendorProposalEdit)
        
        this.createForm()
        const controls = this.vpForm.controls
      
        if(this.vendorProposalEdit.vp_vend != null && this.vendorProposalEdit.vp_vend != "") {
        this.providersService.getBy({ vd_addr: this.vendorProposalEdit.vp_vend }).subscribe((respvend: any) => {
  ...
  createForm() {
      ...
      this.vpForm = this.vpFB.group({
          ...
          vp_ex_rate : [this.vendorProposalEdit.vp_ex_rate],
          vp_ex_rate2: [this.vendorProposalEdit.vp_ex_rate2],
          ...
          vp_pay_meth: [this.vendorProposalEdit.vp_pay_meth],
          dec01: [{value: this.vendorProposalEdit.dec01, disabled :true}],
          
          vp_vend_lead: [this.vendorProposalEdit.vp_vend_lead],
          vp_comment: [this.vendorProposalEdit.vp_comment],
      })
  }
  ...
  addVp(_vp: any, detail: any) {
    ...
    this.vendorProposalService.update({ vendorProposal: _vp, vendorProposalDetail: detail },this.vendorProposalEdit.id).subscribe(
