...
@Component({
  selector: 'kt-customer-settings-list',
  templateUrl: './customer-settings-list.component.html',
  styleUrls: ['./customer-settings-list.component.scss']
})
export class CustomerSettingsListComponent implements OnInit {
  ...
  constructor(
    ...
    prepareGrid() {
      ...
      // },
          ...
          filter: {
            collection: [ { value: 'cm_type', label: 'Type' },{ value: 'cm_region', label: 'Région' }, { value: 'cm_shipvia', label: 'Mode Expédition' }, { value: 'cm_promo', label: 'Groupe Promotion' },{ value: 'cm_lang', label: 'Langue' }, { value: 'cm_pay_method', label: 'Mode de Paiement' },{ value: 'cm_cr_terms', label: 'Délai de Paiement' },{ value: 'cm_class', label: 'Classe' } ],
      ...
      this.dataset = []
      this.codeService.getAllCustomer().subscribe(
          (response: any) => {
