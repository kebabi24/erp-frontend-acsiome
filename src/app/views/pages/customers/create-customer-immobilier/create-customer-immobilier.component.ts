...
@Component({
  ...
  templateUrl: './create-customer-immobilier.component.html',
  styleUrls: ['./create-customer-immobilier.component.scss']
})
export class CreateCustomerImmobilierComponent implements OnInit {
    // Private password
      ...
      const date = new Date;
       ...
       // document.getElementById("bill").focus();
        ...
        this.addressForm = this.formBuilder.group({
            ...
            ad_line2:  [{ value: this.address.ad_line2, disabled: !this.isExist },Validators.required],
            ad_date: [{
              year:date.getFullYear(),
              month: date.getMonth()+1,
              day: date.getDate()
            }],
            ad_line3:  [{ value: this.address.ad_line3, disabled: !this.isExist },Validators.required],
...
console.log("hhhhhhhhhhhhhhhlllllllllllllllllllllllllllllll")
    ...
    prepareAddress(): Address {
        ...
        _address.ad_line2 = controls.ad_line2.value
        _address.ad_line3 = controls.ad_line3.value
        ...
        _address.ad_date = controls.ad_date.value
        _address.ad_mod_date =  controls.ad_mod_date.value
