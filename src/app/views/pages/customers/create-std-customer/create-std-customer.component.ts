...
@Component({
  selector: 'kt-create-std-customer',
  templateUrl: './create-std-customer.component.html',
  styleUrls: ['./create-std-customer.component.scss']
})
export class CreateStdCustomerComponent implements OnInit {
