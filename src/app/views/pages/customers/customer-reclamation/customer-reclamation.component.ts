...
import { SaleOrderService, printCustomerCAList, CustomerService, Code } from "../../../../core/erp"
@Component({
...
onSubmit() {
  ...
  this.customerService.createComplaint(complaintData,complaintDetails,customerData).subscribe(
    (reponse) => {
