...
@Component({
  selector: 'kt-list-payment-role',
  templateUrl: './list-payment-role.component.html',
  styleUrls: ['./list-payment-role.component.scss']
})
export class ListPaymentRoleComponent implements OnInit {
  ...
  solist() {
    ...
    this.mobileSettingsService.getAllPaymentByRole(obj).subscribe(
      (response: any) => {   
        this.mvdataset = response.data
       console.log(this.mvdataset)
     //  this.mvdataView.setItems(this.mvdataset);
