...
@Component({
  ...
  templateUrl: './list-invoice-role.component.html',
  styleUrls: ['./list-invoice-role.component.scss']
})
export class ListInvoiceRoleComponent implements OnInit {
  ...
  solist() {
    ...
    this.loadRequestService.getRoles(this.user.usrd_code).subscribe(
      (response: any) => {
        ...
        this.mobileSettingsService.getAllInvoicesRole(obj).subscribe(
          (response: any) => {   
