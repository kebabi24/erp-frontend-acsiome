...
import {  SiteService,GeneralLedgerService} from "../../../../core/erp"
import {
  NgbDropdownConfig,
  NgbTabChangeEvent,
  NgbTabsetConfig,
...
@Component({
  selector: 'kt-list-g50',
  templateUrl: './list-g50.component.html',
  styleUrls: ['./list-g50.component.scss']
})
export class ListG50Component implements OnInit {
  ...
  prepareGrid() {
      ...
      this.columnDefinitions = [
          ...
          {
            id: "CAE",
            name: "chiffre d'affaire exonéré",
            field: "CAE",
            sortable: true,
            filterable: true,
            groupTotalsFormatter: GroupTotalFormatters.sumTotalsColored ,
          ...
          {
            id: "CAI",
            name: "chiffre d'affaire imposable",
            field: "CAI",
            sortable: true,
            filterable: true,
            groupTotalsFormatter: GroupTotalFormatters.sumTotalsColored ,
...
onGroupChanged(change: { caller?: string; groupColumns: Grouping[] }) {
  ...
  const site = controls.tr_site.value
    ...
    let obj= {site,date,date1}
    this.generalLedgerService.get50(obj).subscribe(
      (res: any) => {
