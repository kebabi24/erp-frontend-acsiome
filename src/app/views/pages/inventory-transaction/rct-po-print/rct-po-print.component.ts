...
@Component({
  selector: 'kt-rct-po-print',
  templateUrl: './rct-po-print.component.html',
  styleUrls: ['./rct-po-print.component.scss']
})


export class RctPoPrintComponent implements OnInit {
  seuil : any;
  nom:any;
...
let date = new Date()
    ...
    var img = new Image();
    // img.src = "./assets/media/logos/rct-po-print.png";
