...
@Component({
  selector: 'kt-iss-unp-globalprint',
  templateUrl: './iss-unp-globalprint.component.html',
  styleUrls: ['./iss-unp-globalprint.component.scss']
})

export class IssUnpGlobalprintComponent implements OnInit {
...
/***********/
  ...
  handleSelectedRowsChanged2(e, args) {
    ...
    ? `${controls.tr_effdate.value.year}/${controls.tr_effdate.value.month}/${controls.tr_effdate.value.day}`
    : null;
       this.inventoryTransactionService.getByRef({ tr_type:'ISS-UNP',tr_effdate:date1,tr_addr:item.ad_addr }).subscribe(
        (res: any) => {
...
printpdf(nbr) {
 ...
 // doc.text('This is client-side Javascript, pumping out a PDF.', 20, 30);
  var img = new Image()
  // img.src = "./assets/media/logos/iss-unp-global.png";
  ...
  doc.text("Adresse : " + code, 20, 50);
  doc.text("Nom             : " + name, 20, 55);
  doc.text("Lieu      : " + addresse, 20, 60);
