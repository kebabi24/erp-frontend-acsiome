...
@Component({
  selector: 'kt-remodify-cab',
  templateUrl: './remodify-cab.component.html',
  styleUrls: ['./remodify-cab.component.scss']
})

 
export class RemodifyCabComponent implements OnInit {
