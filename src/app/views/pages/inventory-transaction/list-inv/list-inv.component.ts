...
onGroupChanged(change: { caller?: string; groupColumns: Grouping[] }) {
  ...
  const type = (controls.type.value == "R") ? "CYC-RCNT" : "CYC-CNT"
    console.log(site,date,type)
    
    let obj= {site,date,type}
    this.inventoryTransactionService.getInv(obj).subscribe(
      (res: any) => {
