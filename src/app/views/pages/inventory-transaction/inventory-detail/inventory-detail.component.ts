  ...
  prepareGrid() {
      ...
      this.columnDefinitions = [
          ...
          // },
          {
            ...
            grouping: {
              ...
              aggregators: [
               ...
               // new Aggregators.Avg('ovs'),
                 new Aggregators.Sum('ovs'),
                      new Aggregators.Sum('pt_size'),
                new Aggregators.Sum('paid_amt'),
                new Aggregators.Sum('open_amt'),
          ...
          }, 
          {
            ...
            grouping: {
              getter: 'bloc',
              formatter: (g) => `Batiment: ${g.value}  <span style="color:green">(${g.count} items)</span>`,
              aggregators: [
                // (required), what aggregators (accumulator) to use and on which field to do so
               // new Aggregators.Avg('ovs'),
                new Aggregators.Sum('ovs'),
          ...
          },
          {
          ...
          }, 
           {
            ...
            grouping: {
              getter: 'door',
              formatter: (g) => `N° Appart: ${g.value}  <span style="color:green">(${g.count} items)</span>`,
              aggregators: [
                // (required), what aggregators (accumulator) to use and on which field to do so
               // new Aggregators.Avg('ovs'),
                new Aggregators.Sum('ovs'),
          ...
          },
          {
            ...
            grouping: {
              getter: 'level',
              formatter: (g) => `Etage: ${g.value}  <span style="color:green">(${g.count} items)</span>`,
              aggregators: [
                // (required), what aggregators (accumulator) to use and on which field to do so
               // new Aggregators.Avg('ovs'),
                new Aggregators.Sum('ovs'),
         ...
         
          {
            ...
            grouping: {
              getter: 'pt_part_type',
              formatter: (g) => `Type Article: ${g.value}  <span style="color:green">(${g.count} items)</span>`,
             aggregators: [
                // (required), what aggregators (accumulator) to use and on which field to do so
               // new Aggregators.Avg('ovs'),
                new Aggregators.Sum('ovs'),
         ...
         
          {
            ...
            grouping: {
              getter: 'amt',
              formatter: (g) => `Coût: ${g.value}  <span style="color:green">(${g.count} items)</span>`,
              aggregateCollapsed: true,
              collapsed: true,
            }
          }, 
       {
            ...
            grouping: {
              getter: 'ovs',
              formatter: (g) => `OV: ${g.value}  <span style="color:green">(${g.count} items)</span>`,
              aggregateCollapsed: true,
              collapsed: true,
            }
          }, 
          {
            ...
            grouping: {
              getter: 'notaire',
              formatter: (g) => `Notaire: ${g.value}  <span style="color:green">(${g.count} items)</span>`,
            aggregators: [
                // (required), what aggregators (accumulator) to use and on which field to do so
               // new Aggregators.Avg('ovs'),
                new Aggregators.Sum('ovs'),
          ...
          }, 
          {
            ...
            grouping: {
              getter: 'paid_pct',
              formatter: (g) => `% paiment: ${g.value}  <span style="color:green">(${g.count} items)</span>`,
              aggregateCollapsed: true,
              collapsed: true,
            }
          }, 
          {
            ...
            grouping: {
              getter: 'open_amt',
              formatter: (g) => `Montant restant: ${g.value}  <span style="color:green">(${g.count} items)</span>`,
              aggregateCollapsed: true,
              collapsed: true,
            }
          }, 
          {
            ...
            grouping: {
              getter: 'open_pct',
              formatter: (g) => `% restant: ${g.value}  <span style="color:green">(${g.count} items)</span>`,
              aggregateCollapsed: true,
              collapsed: true,
            }
          }, 
