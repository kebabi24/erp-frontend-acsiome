...
@Component({
  selector: 'kt-purchase-receipt-cab',
  templateUrl: './purchase-receipt-cab.component.html',
  styleUrls: ['./purchase-receipt-cab.component.scss']
}) 


export class PurchaseReceiptCabComponent implements OnInit {
  seuil : any;
  poids:any;
  nom:any;
