...
@Component({
  selector: 'kt-rct-unp-print', 
  templateUrl: './rct-unp-print.component.html',
  styleUrls: ['./rct-unp-print.component.scss']
})


export class RctUnpPrintComponent implements OnInit {
  seuil : any;
  nom:any;
