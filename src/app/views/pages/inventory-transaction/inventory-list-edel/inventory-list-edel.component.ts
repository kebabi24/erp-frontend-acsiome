...
@Component({
  selector: 'kt-inventory-list-edel',
  templateUrl: './inventory-list-edel.component.html',
  styleUrls: ['./inventory-list-edel.component.scss']
})
export class InventoryListEdelComponent implements OnInit {
  ...
  prepareGrid() {
      ...
      this.dataset = []
      this.locationDetailService.getAllEdel().subscribe( 
