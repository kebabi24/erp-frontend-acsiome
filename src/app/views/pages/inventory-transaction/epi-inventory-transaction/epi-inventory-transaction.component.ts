...
@Component({
  selector: 'kt-epi-inventory-transaction',
  templateUrl: './epi-inventory-transaction.component.html',
  styleUrls: ['./epi-inventory-transaction.component.scss']
})
export class EpiInventoryTransactionComponent implements OnInit {
