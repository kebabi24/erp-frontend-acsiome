...
@Component({
  selector: 'kt-bobine-receipt-cab',
  templateUrl: './bobine-receipt-cab.component.html',
  styleUrls: ['./bobine-receipt-cab.component.scss']
})
export class BobineReceiptCabComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.codeService.getByOne({ code_fldname: "BOBINE",code_value: this.user.usrd_code }).subscribe(
      (reponse: any) => {
