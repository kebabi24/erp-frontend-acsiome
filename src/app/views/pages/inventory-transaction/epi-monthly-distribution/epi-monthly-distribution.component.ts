...
@Component({
  selector: 'kt-epi-monthly-distribution',
  templateUrl: './epi-monthly-distribution.component.html',
  styleUrls: ['./epi-monthly-distribution.component.scss']
})
export class EpiMonthlyDistributionComponent implements OnInit {
          ...
          
{
            ...
            grouping: {
              getter: 'emp_addr',
              formatter: (g) => `Code Employé: ${g.value}  <span style="color:green">(${g.count} items)</span>`,
              aggregators: [
          ...
          }, 
          {
            ...
            grouping: {
              getter: 'emp_lname',
              formatter: (g) => `Prénom: ${g.value}  <span style="color:green">(${g.count} items)</span>`,
              aggregators: [
                // (required), what aggregators (accumulator) to use and on which field to do so
               // new Aggregators.Avg('tr_qty_loc'),
                new Aggregators.Sum('tr_qty_loc'),
          ...
          }, 
          {
            ...
            grouping: {
              getter: 'emp_upper',
              formatter: (g) => `Structure: ${g.value}  <span style="color:green">(${g.count} items)</span>`,
              aggregators: [
                // (required), what aggregators (accumulator) to use and on which field to do so
               // new Aggregators.Avg('tr_qty_loc'),
                new Aggregators.Sum('tr_qty_loc'),
          ...
          }, 
          {
          ...
          },
           {
            ...
            grouping: {
              getter: 'emp_line2',
              formatter: (g) => `Spécialité: ${g.value}  <span style="color:green">(${g.count} items)</span>`,
              aggregators: [
                // (required), what aggregators (accumulator) to use and on which field to do so
               // new Aggregators.Avg('tr_qty_loc'),
                new Aggregators.Sum('tr_qty_loc'),
          ...
          //editorOptions: { minDate: 'today' } as FlatpickrOption
            ...
            grouping: {
              getter: 'emp_first_date',
              formatter: (g) => `Date entrée: ${g.value}  <span style="color:green">(${g.count} items)</span>`,
              aggregators: [
                // (required), what aggregators (accumulator) to use and on which field to do so
               // new Aggregators.Avg('tr_qty_loc'),
                new Aggregators.Sum('tr_qty_loc'),
          ...
          
          {
            ...
            grouping: {
              getter: 'chr03',
              formatter: (g) => `Pointure: ${g.value}  <span style="color:green">(${g.count} items)</span>`,
              aggregators: [
                // (required), what aggregators (accumulator) to use and on which field to do so
               // new Aggregators.Avg('tr_qty_loc'),
                new Aggregators.Sum('tr_qty_loc'),
          ...
          //editorOptions: { minDate: 'today' } as FlatpickrOption
            ...
            grouping: {
              getter: 'date01',
              formatter: (g) => `Date Distribution: ${g.value}  <span style="color:green">(${g.count} items)</span>`,
              aggregators: [
                // (required), what aggregators (accumulator) to use and on which field to do so
               // new Aggregators.Avg('tr_qty_loc'),
                new Aggregators.Sum('tr_qty_loc'),
      ...
      this.dataset = []
      this.inventorytransactionService.getBydistribution({tr_type:'ISS-EPI'}).subscribe( 
