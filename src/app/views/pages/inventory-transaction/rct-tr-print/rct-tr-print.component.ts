...
@Component({ 
  selector: 'kt-rct-tr-print',
  templateUrl: './rct-tr-print.component.html',
  styleUrls: ['./rct-tr-print.component.scss']
})


export class RctTrPrintComponent implements OnInit {
...
open5(content) {
  ...
  printpdf(nbr) {
   ...
   // doc.text('This is client-side Javascript, pumping out a PDF.', 20, 30);
    var img = new Image()
    // img.src = "./assets/media/logos/rct-tr-print.png";
