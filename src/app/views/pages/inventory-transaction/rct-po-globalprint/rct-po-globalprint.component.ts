...
@Component({
  selector: 'kt-rct-po-globalprint', 
  templateUrl: './rct-po-globalprint.component.html',
  styleUrls: ['./rct-po-globalprint.component.scss']
})


export class RctPoGlobalprintComponent implements OnInit {
  seuil : any;
  nom:any;
  ...
  handleSelectedRowsChanged2(e, args) {
    ...
    : null;
        this.inventoryTransactionService.getByRef({tr_type:'RCT-PO',tr_effdate:date1,tr_addr:item.ad_addr }).subscribe(
          (res: any) => {
...
let date = new Date()
    ...
    var img = new Image();
    // img.src = "./assets/media/logos/rct-po-globalprint.png";
