...
@Component({
  selector: 'kt-create-std-bank',
  templateUrl: './create-std-bank.component.html',
  styleUrls: ['./create-std-bank.component.scss']
})
export class CreateStdBankComponent implements OnInit {
  ...
  createBankForm() {
      ...
      this.formX = this.formBuilder.group({
          ad_addr: [null, Validators.required],
          ad_name: [{ value: null, disabled: !this.isExist },Validators.required],
          ad_line1:  [{ value: null, disabled: !this.isExist },Validators.required],
          bk_user1: [{ value: null, disabled: !this.isExist }],
  ...
  prepareAddress(): Address {
      ...
      _address.ad_addr = controlsX.ad_addr.value
      _address.ad_name = controlsX.ad_name.value
      _address.ad_line1 = controlsX.ad_line1.value
  ...
  prepareBank(): Bank {
      ...
      _bank.bk_user1 = controlsX.bk_user1.value
      _bank.bk_userid = controlsX.bk_user1.value
      return _bank
  }
