...
@Component({ 
  selector: 'kt-epi-byemploye-list',
  templateUrl: './epi-byemploye-list.component.html',
  styleUrls: ['./epi-byemploye-list.component.scss']
})
export class EpiByemployeListComponent implements OnInit {
  repForm: FormGroup;
