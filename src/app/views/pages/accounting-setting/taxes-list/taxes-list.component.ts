...
export class TaxesListComponent implements OnInit {
    ...
    prepareGrid() {
        this.columnDefinitions = [
            ...
            {
              id: "tx2_stx_acct",
              name: "Compte Suspenssion de Taxe",
              field: "tx2_stx_acct",
              sortable: true,
              filterable: true,
              type: FieldType.string,
            ...
            {
              id: "tx2_ar_disc_acct",
              name: "Compte des Remises CC",
              field: "tx2_ar_disc_acct",
              sortable: true,
              filterable: true,
              type: FieldType.string,
            },
            {
              id: "tx2_ap_disc_acct",
              name: "Compte escompte Fournisseur",
              field: "ttx2_ap_disc_acct",
              sortable: true,
              filterable: true,
              type: FieldType.string,
            },
