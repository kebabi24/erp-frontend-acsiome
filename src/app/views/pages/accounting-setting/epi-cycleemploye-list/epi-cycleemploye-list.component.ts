...
@Component({ 
  selector: 'kt-epi-cycleemploye-list',
  templateUrl: './epi-cycleemploye-list.component.html',
  styleUrls: ['./epi-cycleemploye-list.component.scss']
})
export class EpiCycleemployeListComponent implements OnInit {
  repForm: FormGroup;
