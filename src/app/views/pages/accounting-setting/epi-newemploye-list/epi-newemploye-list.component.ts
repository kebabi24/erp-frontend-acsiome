...
@Component({ 
  selector: 'kt-epi-newemploye-list',
  templateUrl: './epi-newemploye-list.component.html',
  styleUrls: ['./epi-newemploye-list.component.scss']
})
export class EpiNewemployeListComponent implements OnInit {
  repForm: FormGroup;
