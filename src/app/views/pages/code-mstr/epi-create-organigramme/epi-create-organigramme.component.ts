...
@Component({  
  ...
  templateUrl: './epi-create-organigramme.component.html',
  styleUrls: ['./epi-create-organigramme.component.scss']
})
export class EpiCreateOrganigrammeComponent implements OnInit {
