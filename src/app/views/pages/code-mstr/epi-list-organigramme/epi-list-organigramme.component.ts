...
@Component({
    selector: "kt-epi-list-organigramme",
    templateUrl: "./epi-list-organigramme.component.html",
    styleUrls: ["./epi-list-organigramme.component.scss"],
})
export class EpiListOrganigrammeComponent implements OnInit {
    ...
    prepareGrid() {
      ...
      `
          ...
          onCellClick: (e: Event, args: OnEventArgs) => {
              ...
              this.router.navigateByUrl(`/code-mstr/epi-create-organigramme`)
          },
      },
      {
        id: "id",
