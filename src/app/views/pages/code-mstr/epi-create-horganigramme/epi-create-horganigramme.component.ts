...
@Component({
    selector: "kt-epi-create-horganigramme",
    templateUrl: "./epi-create-horganigramme.component.html",
    styleUrls: ["./epi-create-horganigramme.component.scss"],
    providers: [NgbDropdownConfig, NgbTabsetConfig],
})
export class EpiCreateHorganigrammeComponent implements OnInit {
    code: Code
    codeForm: FormGroup
    hasFormErrors = false
    isExist = false
   ...
   /* onchangelabel(){
    ...
    createForm() {
        ...
        this.codeForm = this.codeFB.group({
            code_fldname: ['HIERARCHIE_ORGANIGRAMME', Validators.required],
    ...
    prepareCode(): Code {
        ...
        _code.code_fldname = 'HIERARCHIE_ORGANIGRAMME'
