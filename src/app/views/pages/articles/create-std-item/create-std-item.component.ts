...
@Component({
  selector: 'kt-create-std-item',
  templateUrl: './create-std-item.component.html',
  styleUrls: ['./create-std-item.component.scss']
})
export class CreateStdItemComponent implements OnInit {
  item: Item;
