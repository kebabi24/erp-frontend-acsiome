...
@Component({
  selector: 'kt-create-immobilier-mod', 
  templateUrl: './create-immobilier-mod.component.html',
  styleUrls: ['./create-immobilier-mod.component.scss']
})



export class CreateImmobilierModComponent implements OnInit {
  ...
  createForm() {
    ...
    this.form1 = this.formBuilder.group({
      ...
      pt_width: [{ value: 0 }],
      pt_height: [{ value: 0 }],
      pt_size:[{ value: this.item.pt_size }],
  ...
  onChangeCode() {
    ...
    const dec01 = this.pt_model[index].dec01
    this.itemService
        .getByOne({
         ...
         console.log(modeleresponse.data)
          if (modeleresponse.data) {
            ...
            this.codeService.getBy({ code_fldname: 'pt_model',code_value: controls1.pt_model.value }).subscribe((coderesponse: any) => 
              { code_couleur = coderesponse.data[0].code_cmmt, vitesse=Number(coderesponse.data[0].dec01)
                ...
                controls1.pt_part.setValue(controls1.pt_article.value + controls1.pt_model.value )
                controls1.pt_desc1.setValue(controls1.pt_draw.value + " " + controls1.pt_part_type.value + " " + controls1.pt_group.value + " " + code_couleur)
                controls1.pt_size.setValue(vitesse)
          });
