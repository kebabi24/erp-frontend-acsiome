...
@Component({
  selector: 'kt-part-settings-list',
  templateUrl: './part-settings-list.component.html',
  styleUrls: ['./part-settings-list.component.scss']
})
export class PartSettingsListComponent implements OnInit {
      ...
      this.columnDefinitions = [
        {
          ...
          onCellClick: (e: Event, args: OnEventArgs) => {
              ...
              this.router.navigateByUrl(`/articles/part-settings-edit/${id}`)
          },
      },
      // {
      //   id: "id",
