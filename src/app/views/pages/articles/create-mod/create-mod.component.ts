...
@Component({
  selector: 'kt-create-mod',
  templateUrl: './create-mod.component.html',
  styleUrls: ['./create-mod.component.scss']
})
export class CreateModComponent implements OnInit {
  ...
  createForm() {
    ...
    this.form1 = this.formBuilder.group({
      ...
      mod_desc: [{value :this.itemModel.mod_desc,disabled: !this.isExist }, Validators.required],
      mod_um: [{value :this.itemModel.mod_um,disabled: !this.isExist }, Validators.required],
      
      mod_prod_line: [{value :this.itemModel.mod_prod_line,disabled: !this.isExist }, Validators.required],
      mod_part_type: [{value :this.itemModel.mod_part_type,disabled: !this.isExist }, Validators.required],
      mod_draw: [{value :this.itemModel.mod_draw,disabled: !this.isExist }, Validators.required],
      mod_group: [{value :this.itemModel.mod_group,disabled: !this.isExist }, Validators.required],
      mod_dsgn_grp: [{value :this.itemModel.mod_dsgn_grp,disabled: !this.isExist }, Validators.required],
      mod_origin: [{value :this.itemModel.mod_origin,disabled: !this.isExist }, Validators.required],
      mod_drwg_loc: [{value :this.itemModel.mod_drwg_loc,disabled: !this.isExist }, Validators.required],
      mod_status: [{value :this.itemModel.mod_status,disabled: !this.isExist }, Validators.required],
      mod_abc: [{value :this.itemModel.mod_abc,disabled: !this.isExist }, Validators.required],
      mod_site: [{value :this.user.usrd_site,disabled: !this.isExist }, Validators.required],
      mod_loc: [{value :this.itemModel.mod_loc,disabled: !this.isExist }, Validators.required],
      mod_iss_pol: [{value :false,disabled: !this.isExist }],
        ...
        .subscribe((response: any) => {
         console.log(response.data)
          if (response.data) {
            ...
            alert("Modele existe deja  ")
            
          } else {

              controls.mod_desc.enable()
              controls.mod_um.enable()
              controls.mod_prod_line.enable()
              
              controls.mod_part_type.enable()
              controls.mod_draw.enable()
              controls.mod_group.enable()
              controls.mod_dsgn_grp.enable()
              controls.mod_origin.enable()
              controls.mod_drwg_loc.enable()
              controls.mod_status.enable()
              controls.mod_abc.enable()
              controls.mod_site.enable()
              controls.mod_loc.enable()
              controls.mod_iss_pol.enable()
  ...
  addItem(item: ItemModel) {
    ...
    this.itemModelService.add(item).subscribe(
      ...
      () => {
                ...
                this.loadingSubject.next(false);
                this.reset()
                this.router.navigateByUrl("/articles/create-mod");
              }
            );
