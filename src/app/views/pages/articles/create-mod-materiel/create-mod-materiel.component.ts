...
export class CreateModMaterielComponent implements OnInit {
  ...
  createForm() {
    ...
    this.form1 = this.formBuilder.group({
      ...
      mod_code: [this.itemModel.mod_code],
      mod_desc: [this.itemModel.mod_desc ],
      mod_um: [this.itemModel.mod_um ],
      mod_promo: [this.itemModel.mod_promo],
      mod_dsgn_grp: [this.itemModel.mod_dsgn_grp],
      mod_origin: [this.itemModel.mod_origin],
