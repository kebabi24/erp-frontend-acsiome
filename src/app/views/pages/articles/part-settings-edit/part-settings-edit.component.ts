...
@Component({ 
  selector: 'kt-part-settings-edit',
  templateUrl: './part-settings-edit.component.html',
  styleUrls: ['./part-settings-edit.component.scss']
})
export class PartSettingsEditComponent implements OnInit {
  code: Code
    codeForm: FormGroup
    hasFormErrors = false
...
check_form: any[] = []
    ...
    createForm() {
        ...
        this.codeForm = this.codeFB.group({
            ...
            code_desc: [ {value:this.codeEdit.code_desc}],
            dec01: [{value:this.codeEdit.dec01}],
    ...
    goBack() {
        this.loadingSubject.next(false)
        const url = `/articles/part-settings-list`
