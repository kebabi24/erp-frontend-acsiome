...
@Component({ 
  selector: 'kt-create-mod-immobilier',
  templateUrl: './create-mod-immobilier.component.html',
  styleUrls: ['./create-mod-immobilier.component.scss']
})

export class CreateModImmobilierComponent implements OnInit {
  ...
  constructor(
    ...
    this.codeService
      .getBy({ code_fldname: "pt_prod_line",code_desc:'IMMOBILIER' })
      .subscribe((response: any) => (this.mod_prod_line = response.data));
    this.codeService
      .getBy({ code_fldname: "pt_part_type",code_desc:'IMMOBILIER' })
      .subscribe((response: any) => (this.mod_part_type = response.data));
    this.codeService
      .getBy({ code_fldname: "pt_draw",code_desc:'IMMOBILIER' })
      .subscribe((response: any) => (this.mod_draw = response.data));
    this.codeService
      .getBy({ code_fldname: "pt_group", code_desc: 'IMMOBILIER' })
      .subscribe((response: any) => (this.mod_group = response.data));  
    this.codeService
      .getBy({ code_fldname: "pt_promo",code_desc:'IMMOBILIER' })
      .subscribe((response: any) => (this.mod_promo = response.data));
      this.codeService
      .getBy({ code_fldname: "pt_dsgn_grp",code_desc:'IMMOBILIER' })
      .subscribe((response: any) => (this.mod_dsgn_grp = response.data));
    this.codeService
      .getBy({ code_fldname: "pt_origin",code_desc:'IMMOBILIER' })
      .subscribe((response: any) => (this.mod_origin = response.data));  
    this.codeService
      .getBy({ code_fldname: "pt_drwg_loc",code_desc:'IMMOBILIER' })
  ...
  goBack() {
    this.loadingSubject.next(false);
    const url = `/articles/create-mod-immobilier`;
        ...
        .subscribe((response: any) => {
         console.log(response.data)
          if (response.data != null) {
            ...
            this.codeService.getBy({ code_fldname: 'pt_draw',code_value: controls.mod_draw.value }).subscribe((drawresponse: any) => {code_draw = drawresponse.data[0].code_cmmt
              this.codeService.getBy({ code_fldname: 'pt_part_type',code_value: controls.mod_part_type.value }).subscribe((typeresponse: any) => {code_type = typeresponse.data[0].code_cmmt
                this.codeService.getBy({ code_fldname: 'pt_group',code_value: controls.mod_group.value }).subscribe((grouperesponse: any) => {code_group = grouperesponse.data[0].code_cmmt
                  controls.mod_code.setValue(controls.mod_prod_line.value + controls.mod_part_type.value + controls.mod_draw.value +  controls.mod_group.value )
                    controls.mod_desc.setValue(code_type + ' ' + code_draw + ' ' + code_group )
  ...
  addItem(item: ItemModel) {
    ...
    this.itemModelService.add(item).subscribe(
      ...
      () => {
                ...
                this.loadingSubject.next(false);
                this.reset()
                this.router.navigateByUrl("/articles/create-mod-immobilier");
              }
            );
