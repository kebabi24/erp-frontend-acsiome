...
@Component({
  selector: 'kt-copie-article',
  templateUrl: './copie-article.component.html',
  styleUrls: ['./copie-article.component.scss']
})
export class CopieArticleComponent implements OnInit {
...
const controls1 = this.form1.controls
  ...
  document.getElementById("pt_part").focus();
    }
  ...
  onChangeCode() {
    const controls1 = this.form1.controls
    console.log("herrrrrrrrrrrrrrrrrre",controls1.pt_part.value,controls1.pt_desc1.value)
    this.itemService
    .getByOne({
    ...
    console.log(response.data)
        if (response.data) {
          alert("Code Article déja Exit")
          controls1.pt_part.setValue(null);
          document.getElementById("pt_part").focus();
        } else {
            console.log("herrrrrrrrrrrrrrrrrre",controls1.pt_part.value)
        }
      })
  }
  // save data
...
console.log(controls1.pt_part.value)
this.itemService
.getByOne({
    pt_part: controls1.pt_part.value,
})
          ...
          () => {
            this.sctService.add(sct2).subscribe(
              ...
              () => {
                ...
                this.loadingSubject.next(false);
                this.router.navigateByUrl("/articles/list-copie");
              }
            );
          }
        );
