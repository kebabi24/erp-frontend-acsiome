...
@Component({
  selector: 'kt-list-vh',
  templateUrl: './list-vh.component.html',
  styleUrls: ['./list-vh.component.scss']
})
export class ListVhComponent implements OnInit {
      ...
      this.mvcolumnDefinitions = [
          ...
          },
          {
            ...
            grouping: {
                ...
                aggregators: [
                  new Aggregators.Sum('ap_amt'),  
                  new Aggregators.Sum('ap_applied'),
                  new Aggregators.Sum('ap_base_amt'),  
                  new Aggregators.Sum('ap_base_applied'),
...
// console.log(this.dataset)
    ...
    solist() {
      ...
      let obj= {date,date1}
      this.accountPayableService.getAllInvoiceBy(obj).subscribe(
        (response: any) => {   
    ...
    printpdf() {
      ...
      for (let j = 0; j < data.length; j++) {
        let mts =  String(  Number(data[j].ap_base_amt).toLocaleString("en-US", {
