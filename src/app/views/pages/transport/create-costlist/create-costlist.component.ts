...
@Component({
  selector: 'kt-create-costlist',
  templateUrl: './create-costlist.component.html',
  styleUrls: ['./create-costlist.component.scss']
})
export class CreateCostlistComponent implements OnInit {
...
createForm() {
 ...
 this.costlist = new Costlist()
  this.ltrcForm = this.ltrcFB.group({
     ltrc_code: [this.costlist.ltrc_code, Validators.required],
     ltrc_desc: [
          { value:this.costlist.ltrc_desc, disabled: !this.isExist },
          Validators.required,
      ],
     ltrc_site: [{ value:this.costlist.ltrc_site, disabled: !this.isExist }, Validators.required],
     ltrc_curr: [{ value:this.costlist.ltrc_curr, disabled: !this.isExist }, Validators.required],
     ltrc_trc_code: [{ value:this.costlist.ltrc_trc_code, disabled: !this.isExist }, Validators.required],
     ltrc_um: [{ value:this.costlist.ltrc_um, disabled: !this.isExist }, Validators.required],

     ltrc_type: [{ value:this.costlist.ltrc_type, disabled: !this.isExist }],
     trcdesc: [{ value:null , disabled: true }],
     ltrc_trmode: [{ value:this.costlist.ltrc_trmode, disabled: !this.isExist }],
  })
}
...
onChangeCode() {
 ...
 this.costlistService
      .getByOne({
           ltrc_code: controls.ltrc_code.value,
      })
      .subscribe((response: any) => {
          ...
          if (response.data) {
              ...
              controls.ltrc_desc.enable()
              controls.ltrc_site.enable()
              controls.ltrc_curr.enable()
              controls.ltrc_trc_code.enable()
              controls.ltrc_type.enable()
              controls.ltrc_um.enable()
              controls.ltrc_trmode.enable()
              document.getElementById("ltrc_desc").focus(); 
          }
   })
}
//reste form
...
onSubmit() {
  ...
  let list = this.prepareCode()
  this.addCode(list,this.dataset)
}
/**
...
/**
     ...
     */
    addCode(_costlist: any , detail: any) {
     ...
     this.costlistService.add({costlist: _costlist, costlistDetail: detail}).subscribe(
          ...
          () => {
              ...
              this.loadingSubject.next(false)
              this.reset()
              this.router.navigateByUrl("/transport/create-costlist")
          }
      )
  }
 ...
 /**
    ...
    goBack() {
      this.loadingSubject.next(false)
      const url = `/transport/create-costlist`
