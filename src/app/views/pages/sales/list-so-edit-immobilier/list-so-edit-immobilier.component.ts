...
@Component({
  selector: 'kt-list-so-edit-immobilier',
  templateUrl: './list-so-edit-immobilier.component.html',
  styleUrls: ['./list-so-edit-immobilier.component.scss']
})
export class ListSoEditImmobilierComponent implements OnInit {
