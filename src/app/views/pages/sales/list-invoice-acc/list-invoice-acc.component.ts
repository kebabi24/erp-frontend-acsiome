...
@Component({
  selector: 'kt-list-invoice-acc',
  templateUrl: './list-invoice-acc.component.html',
  styleUrls: ['./list-invoice-acc.component.scss']
})
export class ListInvoiceAccComponent implements OnInit {
  ...
  solist() {
    ...
    this.mobileSettingsService.getAllInvoicesAcc(obj).subscribe(
      (response: any) => {   
...
this.dataset= []
       ...
       this.mobileSettingsService.getAllInvoicesLineAcc(obj).subscribe(
        (respo: any) => {   
