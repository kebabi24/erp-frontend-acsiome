...
@Component({
  selector: 'kt-list-credit-dd',
  templateUrl: './list-credit-dd.component.html',
  styleUrls: ['./list-credit-dd.component.scss']
})
export class ListCreditDdComponent implements OnInit {
