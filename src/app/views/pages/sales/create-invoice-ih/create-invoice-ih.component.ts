...
@Component({
  selector: 'kt-create-invoice-ih',
  templateUrl: './create-invoice-ih.component.html',
  styleUrls: ['./create-invoice-ih.component.scss']
})
export class CreateInvoiceIhComponent implements OnInit {
...
//     do {
//   if (this.ihdataset[j].itdh_part = det.Id ) {
