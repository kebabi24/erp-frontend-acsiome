...
@Component({
  selector: 'kt-list-sales-acc',
  templateUrl: './list-sales-acc.component.html',
  styleUrls: ['./list-sales-acc.component.scss']
})
export class ListSalesAccComponent implements OnInit {
  ...
  /*    {
    ...
    this.mobileSettingsService.getAllInvoicesDetAcc(obj).subscribe(
      (response: any) => {   
