...
@Component({
  selector: 'kt-create-so-bc',
  templateUrl: './create-so-bc.component.html',
  styleUrls: ['./create-so-bc.component.scss']
})
export class CreateSoBcComponent implements OnInit {
  ...
  prepareSo(): any {
    ...
    if (Number(this.customer.cm_cr_limit) != 0) {
