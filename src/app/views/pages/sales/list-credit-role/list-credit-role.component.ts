...
@Component({
  selector: 'kt-list-credit-role',
  templateUrl: './list-credit-role.component.html',
  styleUrls: ['./list-credit-role.component.scss']
})
export class ListCreditRoleComponent implements OnInit {
...
role:any[]
  ...
  solist() {
    ...
    this.loadRequestService.getRoles(this.user.usrd_code).subscribe(
      (response: any) => {
        ...
        this.mobileSettingsService.getAllCreditsRole(obj).subscribe(
          (response: any) => {   
  ...
  printpdf() {
    ...
    doc.setFontSize(14);
    doc.text("Liste des Crédits    " , 120, 40);
    doc.setFontSize(12);
     ...
     // console.log(mnsolde)
      ...
      let ttcredit = replaceAll(tcredit,","," ")
       doc.line(85, i - 5, 85, i);
        ...
        doc.text("Totaux", 188, i - 1,{ align: "right" });
        doc.line(190, i - 5, 190, i);
