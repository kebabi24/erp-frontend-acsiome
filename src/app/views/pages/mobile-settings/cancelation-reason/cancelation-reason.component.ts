...
export class CancelationReasonComponent implements OnInit {
  ...
  prepareGrid() {
    this.columnDefinitions = [
              ...
              {
                  id: "cancelation_reason_code",
                  name: "Code du motif d annulation",
                  field: "cancelation_reason_code",
                  sortable: true,
                  editor: {
                    model: Editors.text,
                  },
              ...
              {
                  id: "name",
                  name: "Nom du motif d annulation",
                  field: "name",
                  sortable: true,
                  editor: {
                    model: Editors.text,
    ...
    this.mobileSettingsService.getAllCancelationReasons().subscribe(
      (response: any) => {
        this.dataset = response.cancelationReasons
