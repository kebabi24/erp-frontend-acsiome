...
@Component({
  selector: 'kt-training-cold-eval',
  templateUrl: './training-cold-eval.component.html',
  styleUrls: ['./training-cold-eval.component.scss']
})
export class TrainingColdEvalComponent implements OnInit {
    site: Site
