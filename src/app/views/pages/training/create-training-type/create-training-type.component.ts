...
@Component({
  selector: 'kt-create-training-type',
...
indexd:any
  ...
  prepareGrid() {
    this.columnDefinitions = [
              {
                ...
                onCellClick: (e: Event, args: OnEventArgs) => {
                  ...
                  this.codeService.getByOne(
                    {code_fldname:"pt_draw",chr01: args.dataContext.code_value},
                    ).subscribe(
                    (response: any) => {
                      console.log(response.data)
                     if(response.data != null) {
                      alert("domaines existent pour ce code")
                     }
                      else {
    ...
    this.codeService.getBy({code_fldname:"pt_dsgn_grp"}).subscribe(
      (response: any) => {
...
console.log("hereeeeeeeeeeeeeeeeee")
  this.codeService.getBy(
    {code_fldname:"pt_draw",chr01: this.code},
    ).subscribe(
    (response: any) => {
      console.log(response.data)
      this.datasettr = response.data
