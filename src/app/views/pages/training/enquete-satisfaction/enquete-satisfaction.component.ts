...
@Component({
  selector: 'kt-enquete-satisfaction', 
  templateUrl: './enquete-satisfaction.component.html',
  styleUrls: ['./enquete-satisfaction.component.scss']
})
export class EnqueteSatisfactionComponent implements OnInit {
    site: Site
    ...
    onSubmit() {
        ...
        this.qualityControlService.createTestHistory(lines).subscribe(
          ...
          () => {
              ...
              this.router.navigateByUrl("/training/enquete-satisfaction");
