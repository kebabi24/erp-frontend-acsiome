...
@Component({
  selector: 'kt-list-user-mobile',
  templateUrl: './list-user-mobile.component.html',
  styleUrls: ['./list-user-mobile.component.scss']
})
export class ListUserMobileComponent implements OnInit {
  ...
  prepareGrid() {
      ...
      this.dataset = []
      this.usersMobileService.getAllUsers().subscribe(
