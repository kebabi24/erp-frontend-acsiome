...
@Component({
  selector: 'kt-calc-cout-wo',
  templateUrl: './calc-cout-wo.component.html',
  styleUrls: ['./calc-cout-wo.component.scss']
})
export class CalcCoutWoComponent implements OnInit {
...
: null;
  ...
  this.workOrderService.CalcCost(obj).subscribe(
    (response: any) => {   
