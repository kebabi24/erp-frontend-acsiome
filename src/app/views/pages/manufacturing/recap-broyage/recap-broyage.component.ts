...
@Component({
  selector: 'kt-recap-broyage',
  templateUrl: './recap-broyage.component.html',
  styleUrls: ['./recap-broyage.component.scss']
})

export class RecapBroyageComponent implements OnInit {
 ...
 /*for (var i= 0; i < this.dataset.length ; i++){
  ...
  wolist() {
    ...
    : null;
    if(site != null) {
    this.workOrderService.getBrRecap({site,date,date1}).subscribe(
      (response: any) => {   
