...
import {
  ItemService, Ps, BomService,PsService,CodeService

} from "../../../../core/erp";

 
@Component({
  selector: 'kt-bareme-epi-article',
  templateUrl: './bareme-epi-article.component.html',
  styleUrls: ['./bareme-epi-article.component.scss']
})
export class BaremeEpiArticleComponent implements OnInit {
    ...
    this.columnDefinitions = [
      ...
      },
      {
        ...
        onCellChange: (e: Event, args: OnEventArgs) => {
          ...
          this.itemsService.getByOne({pt_part: args.dataContext.ps_comp,pt_prod_line:'EPI'}).subscribe((resp:any)=>{
  ...
  onChangeCode() {
    ...
    this.codeService
        .getBy({
              code_desc: controls.ps_parent.value,
        })
        .subscribe((response: any) => {
            ...
            if (!response.data) {
              ...
              controls.ps_userid.setValue(response.data.code_value);
  ...
  prepare(){
    ...
    _ps.ps_userid = controls.ps_userid.value
    _ps.ps_joint_type = 'EPI'
    return _ps
  }
  /**
   *
