...
@Component({
  selector: 'kt-list-wo-pf',
  templateUrl: './list-wo-pf.component.html',
  styleUrls: ['./list-wo-pf.component.scss']
})
export class ListWoPfComponent implements OnInit {
  ...
  prepareGrid() {
      ...
      this.dataset = []
      this.workOrderService.getBythermo({wo_routing:'M1'}).subscribe(
  ...
  prepareGrid1() {
    ...
    this.dataset1 = []
    this.workOrderService.getPrograms({}).subscribe(
