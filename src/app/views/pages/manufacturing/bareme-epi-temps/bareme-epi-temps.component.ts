...
@Component({
    selector: "kt-bareme-epi-temps",
    templateUrl: "./bareme-epi-temps.component.html",
    styleUrls: ["./bareme-epi-temps.component.scss"],
    providers: [NgbDropdownConfig, NgbTabsetConfig],
})
export class BaremeEpiTempsComponent implements OnInit {
    code: Code
    codeForm: FormGroup
    hasFormErrors = false
    isExist = false
   ...
   /* onchangelabel(){
    ...
    prepareCode(): Code {
        ...
        _code.code_fldname = 'bareme_temps'
