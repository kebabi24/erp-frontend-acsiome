...
@Component({
    selector: "kt-create-loc-immobilier",
    templateUrl: "./create-loc-immobilier.component.html",
    styleUrls: ["./create-loc-immobilier.component.scss"],
    providers: [NgbDropdownConfig, NgbTabsetConfig],
})
export class CreateLocImmobilierComponent implements OnInit {
    location: Location
