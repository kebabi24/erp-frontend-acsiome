...
@Component({
    selector: "kt-create-site-immobilier",
    templateUrl: "./create-site-immobilier.component.html",
    styleUrls: ["./create-site-immobilier.component.scss"],
    providers: [NgbDropdownConfig, NgbTabsetConfig],
})
export class CreateSiteImmobilierComponent implements OnInit {
    site: Site
    siteForm: FormGroup
    hasFormErrors = false
