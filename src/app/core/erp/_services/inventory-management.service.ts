...
export class InventoryManagementService {
  ...
  public getLoadRequestDataV3(load_request_code: any) {
    const httpHeaders = this.httpUtils.getHTTPHeaders();
    return this.http.get(`${API_URL_2}/findLoadRequestDataV3/${load_request_code}`, { headers: httpHeaders });
  }
  ...
  public createLoadRequestDetailsScan(details: any, lines: any, dataligne:any) {
    const httpHeaders = this.httpUtils.getHTTPHeaders();
