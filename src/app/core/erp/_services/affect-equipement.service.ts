...
// model
import { AffectEquipement } from "../_models/affect-equipement.model"

const API_URL = environment.apiUrl + "/affectequipements"

@Injectable()
export class AffectEquipementService {
    ...
    // CREATE
    public add(ae: AffectEquipement) {
        const httpHeaders = this.httpUtils.getHTTPHeaders()
        return this.http.post(API_URL, ae, { headers: httpHeaders })
    }
